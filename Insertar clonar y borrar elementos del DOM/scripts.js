...
// list.replaceChild(newElement, list.children[0]) //remplaza un hijo por otro
...
//list.prepend(newElement) // Lo coloca como primer hijo
...
// list.remove() // Elimina el nodo completo con todos sus hijos
// list.removeChild(list.children[0]) // Elimina un hijo especifico del nodo
